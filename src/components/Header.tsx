...
class Header extends Component<NavProps, NavState> {
  ...
  render() {
    return <nav className="navbar is-fixed-top limited-navbar" role="navigation" aria-label="main navigation">
      <div className="navbar-brand">
        <a className="navbar-item" style={{fontSize: "1.5rem", padding: "0 1rem"}} href="/">
          {title}
        </a>
